			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="kegiatan" id="kegiatan"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="acuan_pengawasan" id="acuan_pengawasan"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getKegiatan();?></td>
						<td>
							<input class="form-control" type="text" name="kegiatan" id="kegiatan" value="<?php echo $pekerjaan->getKegiatan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getJumlahPekerja();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getAcuanPengawasan();?></td>
						<td>
							<input class="form-control" type="text" name="acuan_pengawasan" id="acuan_pengawasan" value="<?php echo $pekerjaan->getAcuanPengawasan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getBillOfQuantityId();?></td>
