 ...
 */
class ListForm extends ToString
{
    /**
     ...
     *
     * @return ListFormData|null The data structure for the form.
     */
     ...
     *
     * @param ListFormData|null $data The data structure to set.
     * @return self The current instance for method chaining.
     */
