...
/**
 * The TskUmk class represents an entity in the "tsk" table.
 *
 * This entity maps to the "tsk" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="tsk")
 */
class TskUmk extends MagicObject
{
	/**
	 * Tsk ID
	 * 
