...
/**
 * The TemplateSimak class represents an entity in the "template_simak" table.
 *
 * This entity maps to the "template_simak" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="template_simak")
 */
class TemplateSimak extends MagicObject
{
	/**
	 * Template Simak ID
	 * 
	 ...
	 * @NotNull
	 * @Column(name="template_simak_id", type="bigint(20)", length=20, nullable=false, extra="auto_increment")
	 * @Label(content="Template Simak ID")
	 * @var int
	 */
	protected $templateSimakId;
	 ...
	 * Data Template
	 * 
	 * @Column(name="data_template", type="longtext", nullable=true)
	 * @Label(content="Data Template")
	 * @var string
	 */
