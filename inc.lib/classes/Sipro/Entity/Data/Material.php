...
/**
 * The Material class represents an entity in the "material" table.
 *
...
class Material extends MagicObject
{
	 ...
	 * Kategori Material
	 * 
	 * @JoinColumn(name="kategori_material_id", referenceColumnName="kategori_material_id")
	 * @Label(content="Kategori Material")
	 * @var KategoriMaterialMin
	 */
	protected $kategoriMaterial;
