...
/**
 * The KategoriMaterialMin class represents an entity in the "kategori_material" table.
 *
 * This entity maps to the "kategori_material" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="kategori_material")
 */
class KategoriMaterialMin extends MagicObject
{
	/**
	 ...
	 * @NotNull
	 * @Column(name="kategori_material_id", type="varchar(20)", length=20, nullable=false)
