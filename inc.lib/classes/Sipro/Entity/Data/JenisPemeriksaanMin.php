...
/**
 * The JenisPemeriksaanMin class represents an entity in the "jenis_pemeriksaan" table.
 *
 ...
 */
class JenisPemeriksaanMin extends MagicObject
{
	/**
	 ...
	 * @var int
	 */
	protected $JenisPemeriksaanMinId;
