...
/**
 * The Pst class represents an entity in the "pst" table.
 *
 * This entity maps to the "pst" table in the database and supports ORM (Object-Relational Mapping) operations. 
...
class Pst extends MagicObject
{
	 ...
	 * @NotNull
	 * @Column(name="pst_id", type="bigint(20)", length=20, nullable=false, extra="auto_increment")
	 * @Label(content="Pst ID")
	 * @var int
	 */
	protected $pstId;
	 ...
	 * Upmk ID
	 * 
	 * @Column(name="upmk_id", type="bigint(20)", length=20, nullable=true)
	 ...
	 * Upmk
	 * 
	 * @JoinColumn(name="upmk_id", referenceColumnName="upmk_id")
	 * @Label(content="Upmk")
	 * @var UpmkMin
	 */
	protected $upmk;
