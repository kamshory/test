...
/**
 * The PeralatanMin class represents an entity in the "peralatan" table.
 *
 * This entity maps to the "peralatan" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 */
class PeralatanMin extends MagicObject
{
	/**
	 * Peralatan ID
	 * 
