...
/**
 * The AdminTrash class represents an entity in the "admin_trash" table.
 *
 * This entity maps to the "admin_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="admin_trash")
 */
class AdminTrash extends MagicObject
{
	/**
	 * Admin Trash ID
	 * 
	 ...
	 * @NotNull
	 * @Column(name="admin_trash_id", type="varchar(40)", length=40, nullable=false)
	 * @Label(content="Admin Trash ID")
	 * @var string
	 */
	protected $adminTrashId;

	/**
	 * Admin ID
	 * 
	 * @NotNull
	 * @Column(name="admin_id", type="bigint(20)", length=20, nullable=false)
	 ...
	 * 
	 * @NotNull
	 * @Column(name="jenis_kelamin", type="varchar(4)", length=4, nullable=false)
