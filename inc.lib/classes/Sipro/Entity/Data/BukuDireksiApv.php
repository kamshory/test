...
/**
 * The BukuDireksiApv class represents an entity in the "buku_direksi_apv" table.
 *
 * This entity maps to the "buku_direksi_apv" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="buku_direksi_apv")
 */
class BukuDireksiApv extends MagicObject
{
	/**
	 * Buku Direksi Apv ID
	 * 
	 ...
	 * @NotNull
	 * @Column(name="buku_direksi_apv_id", type="varchar(40)", length=40, nullable=false)
	 * @Label(content="Buku Direksi Apv ID")
	 * @var string
	 */
	protected $bukuDireksiApvId;
