...
/**
 * The SupervisorTrash class represents an entity in the "supervisor_trash" table.
 *
 * This entity maps to the "supervisor_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
...
class SupervisorTrash extends MagicObject
{
	 ...
	 * @NotNull
	 * @Column(name="supervisor_trash_id", type="varchar(40)", length=40, nullable=false)
