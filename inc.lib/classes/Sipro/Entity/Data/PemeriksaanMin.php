...
/**
 * The PemeriksaanMin class represents an entity in the "pemeriksaan" table.
 *
 * This entity maps to the "pemeriksaan" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 */
class PemeriksaanMin extends MagicObject
{
	/**
	 * Pemeriksaan ID
	 * 
	 ...
	 * @NotNull
	 * @Column(name="pemeriksaan_id", type="bigint(20)", length=20, nullable=false, extra="auto_increment")
