...
/**
 * The AdminApv class represents an entity in the "admin_apv" table.
 *
 * This entity maps to the "admin_apv" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="admin_apv")
 */
class AdminApv extends MagicObject
{
	/**
	 * Admin Apv ID
	 * 
	 ...
	 * @NotNull
	 * @Column(name="admin_apv_id", type="varchar(40)", length=40, nullable=false)
	 * @Label(content="Admin Apv ID")
	 * @var string
	 */
	protected $adminApvId;
