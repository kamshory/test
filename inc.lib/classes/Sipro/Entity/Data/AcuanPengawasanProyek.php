...
/**
 * The AcuanPengawasanProyek class represents an entity in the "acuan_pengawasan_proyek" table.
 *
 * This entity maps to the "acuan_pengawasan_proyek" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="acuan_pengawasan_proyek")
 */
class AcuanPengawasanProyek extends MagicObject
{
	/**
	 * Acuan Pengawasan Proyek ID
	 * 
	 * @Id
	 * @GeneratedValue(strategy=GenerationType.IDENTITY)
	 * @NotNull
	 * @Column(name="acuan_pengawasan_proyek_id", type="bigint(20)", length=20, nullable=false, extra="auto_increment")
	 * @Label(content="Acuan Pengawasan Proyek ID")
	 * @var int
	 */
	protected $acuanPengawasanProyekId;
