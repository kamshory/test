...
/**
 * The BukuDireksiTrash class represents an entity in the "buku_direksi_trash" table.
 *
 * This entity maps to the "buku_direksi_trash" table in the database and supports ORM (Object-Relational Mapping) operations. 
 ...
 * @Table(name="buku_direksi_trash")
 */
class BukuDireksiTrash extends MagicObject
{
	/**
	 * Buku Direksi Trash ID
	 * 
	 * @Id
	 * @GeneratedValue(strategy=GenerationType.UUID)
	 * @NotNull
	 * @Column(name="buku_direksi_trash_id", type="varchar(40)", length=40, nullable=false)
	 * @Label(content="Buku Direksi Trash ID")
	 * @var string
	 */
	protected $bukuDireksiTrashId;

	/**
	 * Buku Direksi ID
	 * 
	 * @NotNull
	 * @Column(name="buku_direksi_id", type="bigint(20)", length=20, nullable=false)
