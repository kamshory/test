...
{
    header('Location: registrasi-supervisor.php');
    exit();
}
            ...
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-7 p-1 mb-0">
                <div class="card-body">
                  ...
                  if($inputGet->getSuccess() == 'false')
                  {
                    $sessions->message = 'Sistem tidak dapat mengirimkan email. Silakan ulangi lagi.';
                    ?>
                    <h1><?php echo $appLanguage->getRegistrationFailed();?></h1>
                    <p><?php echo isset($sessions->message) ? $sessions->message : '';?></p>
                    <?php
                  }
                  else
                  {
                    ...
                    <table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input autocomplete="off" type="text" class="form-control" name="nama_depan" id="nama_depan" value="<?php echo htmlspecialchars($inputPost->getNamaDepan());?>" required="required"/>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $appEntityLanguage->getNamaBelakang();?></td>
                                <td>
                                    <input autocomplete="off" type="text" class="form-control" name="nama_belakang" id="nama_belakang" value="<?php echo htmlspecialchars($inputPost->getNamaBelakang());?>" required />
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $appEntityLanguage->getUsername();?></td>
                                <td>
                                    <input autocomplete="off" type="text" class="form-control" name="username" id="username" value="<?php echo htmlspecialchars($inputPost->getUsername());?>" required />
                                </td>
                            </tr>
                            <tr>
						...
						<td>
							<input autocomplete="off" type="text" class="form-control" name="ukuran_baju" id="ukuran_baju" value="<?php echo htmlspecialchars($inputPost->getUkuranBaju());?>" required />
						</td>
                        </tr>
                        <tr>
                            <td><?php echo $appEntityLanguage->getUkuranSepatu();?></td>
                            <td>
                                <input autocomplete="off" type="text" class="form-control" name="ukuran_sepatu" id="ukuran_sepatu" value="<?php echo htmlspecialchars($inputPost->getUkuranSepatu());?>" required />
                            </td>
                        </tr>
                            <tr>
