                    ...
                    <table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input autocomplete="off" class="form-control" type="text" name="nama_depan" id="nama_depan" value="<?php echo htmlspecialchars($inputPost->getNamaDepan());?>" required="required"/>
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $appEntityLanguage->getNamaBelakang();?></td>
                                <td>
                                    <input autocomplete="off" class="form-control" type="text" name="nama_belakang" id="nama_belakang" value="<?php echo htmlspecialchars($inputPost->getNamaBelakang());?>" required />
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $appEntityLanguage->getUsername();?></td>
                                <td>
                                    <input autocomplete="off" class="form-control" type="text" name="username" id="username" value="<?php echo htmlspecialchars($inputPost->getUsername());?>" required />
                                </td>
                            </tr>
                            <tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="ukuran_baju" id="ukuran_baju" value="<?php echo htmlspecialchars($inputPost->getUkuranBaju());?>" required />
						</td>
                        </tr>
                        <tr>
                            <td><?php echo $appEntityLanguage->getUkuranSepatu();?></td>
                            <td>
                                <input autocomplete="off" class="form-control" type="text" name="ukuran_sepatu" id="ukuran_sepatu" value="<?php echo htmlspecialchars($inputPost->getUkuranSepatu());?>" required />
                            </td>
                        </tr>
                            <tr>
