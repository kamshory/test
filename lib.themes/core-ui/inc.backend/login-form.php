                ...
                <div class="card-body">
                  <form action="login.php" method="post">
                    ...
                    <div class="input-group mb-3"><span class="input-group-text">
                        ...
                        <input type="text" class="form-control" name="username" placeholder="<?php echo $appLanguage->getPlaceholderUsername();?>">
                    </div>
                    <div class="input-group mb-3"><span class="input-group-text">
                        <svg class="icon">
              ...
              <div class="card col-md-5 text-white bg-primary py-5">
                <div class="card-body text-center">
                  <div>
                    ...
                    <button class="btn btn-outline-light mt-3" type="button" onclick="window.location='konfirmasi-email.php'"><?php echo $appLanguage->getEmailConfirmation();?></button>
                  </div>
                </div>
              </div>
            </div>
