                    ...
                    <table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input autocomplete="off" class="form-control" type="text" name="nama_belakang" id="nama_belakang" required />
                                </td>
                            </tr>
                            <tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="ukuran_baju" id="ukuran_baju" required />
						</td>
                        </tr>
                        <tr>
                            <td><?php echo $appEntityLanguage->getUkuranSepatu();?></td>
                            <td>
                                <input autocomplete="off" class="form-control" type="text" name="ukuran_sepatu" id="ukuran_sepatu" required />
                            </td>
                        </tr>
                            <tr>
