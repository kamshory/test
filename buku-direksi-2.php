...
$currentModule = new PicoModule($appConfig, $database, null, "/", "buku-direksi", "Buku Direksi");
...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$bukuDireksi->setKomentarDireksi($inputPost->getKomentarDireksi(PicoFilterConstant::FILTER_DEFAULT, false, false, true));
...
else if($inputPost->getUserAction() == UserAction::UPDATE)
{
	...
	$bukuDireksiApv->setKomentarDireksi($inputPost->getKomentarDireksi(PicoFilterConstant::FILTER_DEFAULT, false, false, true));
...
else if($inputGet->getUserAction() == UserAction::UPDATE)
{
	$bukuDireksi = new BukuDireksi(null, $database);
	try{
		$bukuDireksi->findOneByBukuDireksiId($inputGet->getBukuDireksiId());
		if($bukuDireksi->issetBukuDireksiId())
		{
$appEntityLanguage = new AppEntityLanguage(new BukuDireksi(), $appConfig, $currentUser->getLanguageId());
require_once __DIR__ . "/inc.app/header-supervisor.php";
		if($bukuDireksi->getWaitingFor() == 0 || $bukuDireksi->getWaitingFor() == 1)
		{
?>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getPermasalahan();?></td>
						<td>
							<textarea class="form-control summernote" name="permasalahan" id="permasalahan" spellcheck="false"><?php echo htmlspecialchars($bukuDireksi->getPermasalahan());?></textarea>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getPerkiraanLamaPenyelesaian();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getPenyelesaian();?></td>
						<td>
							<textarea class="form-control summernote" name="penyelesaian" id="penyelesaian" spellcheck="false"><?php echo htmlspecialchars($bukuDireksi->getPenyelesaian());?></textarea>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getStatus();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getKomentarDireksi();?></td>
						<td>
						<textarea class="form-control summernote" type="text" name="komentar_direksi" id="komentar_direksi"><?php echo htmlspecialchars($bukuDireksi->getKomentarDireksi());?></textarea>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
