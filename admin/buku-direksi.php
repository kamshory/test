...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$bukuDireksi->setPenyelesaian($inputPost->getPenyelesaian(PicoFilterConstant::FILTER_SANITIZE_SPECIAL_CHARS, false, false, true));
...
else if($inputPost->getUserAction() == UserAction::UPDATE)
{
	try
	{
		...
		$bukuDireksiApv->setPenyelesaian($inputPost->getPenyelesaian(PicoFilterConstant::FILTER_SANITIZE_SPECIAL_CHARS, false, false, true));
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="lokasi" id="lokasi"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="number" step="1" name="progres" id="progres"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getNomor();?></td>
						<td>
							<input class="form-control" type="text" name="nomor" id="nomor" value="<?php echo $bukuDireksi->getNomor();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getLokasi();?></td>
						<td>
							<input class="form-control" type="text" name="lokasi" id="lokasi" value="<?php echo $bukuDireksi->getLokasi();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getPekerjaan();?></td>
						<td>
							<input class="form-control" type="text" name="pekerjaan" id="pekerjaan" value="<?php echo $bukuDireksi->getPekerjaan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getUraianPermasalahan();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getProgres();?></td>
						<td>
							<input class="form-control" type="number" step="1" name="progres" id="progres" value="<?php echo $bukuDireksi->getProgres();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getSelesai();?></td>
