...
else if($inputPost->getUserAction() == UserAction::UPDATE)
{
	...
	$updater = $lokasiKehadiran->where($specification)
		->setLokasiKehadiranId($inputPost->getLokasiKehadiranId(PicoFilterConstant::FILTER_SANITIZE_SPECIAL_CHARS, false, false, true))
	...
	try
	{
		...
		$lokasiKehadiran = new LokasiKehadiran(null, $database);
		$lokasiKehadiran->where($specification)->setLokasiKehadiranId($newId)->update();
		$currentModule->redirectTo(UserAction::DETAIL, Field::of()->lokasi_kehadiran_id, $newId);
	}
	catch(Exception $e)
	{
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $lokasiKehadiran->getWaktuBuat();?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo $lokasiKehadiran->getAdminBuat();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $lokasiKehadiran->getWaktuUbah();?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo $lokasiKehadiran->getAdminUbah();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
