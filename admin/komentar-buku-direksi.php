...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "komentar-buku-direksi", "Komentar Buku Direksi");
...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$komentarBukuDireksi->setUserId($inputPost->getUserId(PicoFilterConstant::FILTER_SANITIZE_NUMBER_INT, false, false, true));
						...
						<td>
							<select class="form-control" name="user_id" id="user_id">
								...
								PicoSortable::getInstance()
									->add(new PicoSort(Field::of()->sortOrder, PicoSort::ORDER_TYPE_ASC))
									->add(new PicoSort(Field::of()->nama, PicoSort::ORDER_TYPE_ASC)), 
								Field::of()->userId, Field::of()->firstName, $komentarBukuDireksi->getUserId())
								; ?>
							</select>
						</td>
					</tr>
		...
		<form name="detailform" id="detailform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getUser();?></td>
						<td><?php echo $komentarBukuDireksi->issetUser() ? $komentarBukuDireksi->getUser()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuBuat();?></td>
						<td><?php echo $komentarBukuDireksi->getWaktuBuat();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $komentarBukuDireksi->getWaktuUbah();?></td>
					</tr>
					<tr>
					...
					<table class="table table-row table-sort-by-column">
						...
						<tbody data-offset="<?php echo $pageData->getDataOffset();?>">
							...
							<tr data-number="<?php echo $pageData->getDataOffset() + $dataIndex;?>">
								...
								<td data-col-name="user_id"><?php echo $komentarBukuDireksi->issetUser() ? $komentarBukuDireksi->getUser()->getFirstName() : "";?></td>
