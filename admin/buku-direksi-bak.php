...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "buku-direksi", "Buku Direksi");
...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$bukuDireksi->setPermasalahan($inputPost->getPermasalahan(PicoFilterConstant::FILTER_DEFAULT, false, false, true));
	...
	$bukuDireksi->setProgres($inputPost->getProgres(PicoFilterConstant::FILTER_SANITIZE_NUMBER_INT, false, false, true));
	...
	$bukuDireksi->setKomentarDireksi($inputPost->getKomentarDireksi(PicoFilterConstant::FILTER_SANITIZE_SPECIAL_CHARS, false, false, true));
...
else if($inputPost->getUserAction() == UserAction::UPDATE)
{
	...
	$bukuDireksiApv->setPermasalahan($inputPost->getPermasalahan(PicoFilterConstant::FILTER_DEFAULT, false, false, true));
	...
	$bukuDireksiApv->setProgres($inputPost->getProgres(PicoFilterConstant::FILTER_SANITIZE_NUMBER_INT, false, false, true));
	...
	$bukuDireksiApv->setKomentarDireksi($inputPost->getKomentarDireksi(PicoFilterConstant::FILTER_SANITIZE_SPECIAL_CHARS, false, false, true));
	...
	try
	{
		...
		$bukuDireksi->setBukuDireksiId($inputPost->getBukuDireksiId())->setApprovalId($bukuDireksiApv->getBukuDireksiApvId())->setWaitingFor(WaitingFor::UPDATE)->update();
		$newId = $bukuDireksi->getBukuDireksiId();
		$currentModule->redirectTo(UserAction::DETAIL, Field::of()->buku_direksi_id, $newId);
	}
	catch(Exception $e)
		...
		foreach($inputPost->getCheckedRowId() as $rowId)
		{
			...
			try
			{
				$bukuDireksi->where(PicoSpecification::getInstance()
					->addAnd(PicoPredicate::getInstance()->setBukuDireksiId($rowId))
					->addAnd(
...
else if($inputPost->getUserAction() == UserAction::APPROVE)
{
	...
	{
		$bukuDireksiId = $inputPost->getBukuDireksiId();
		$bukuDireksi = new BukuDireksi(null, $database);
		$bukuDireksi->findOneByBukuDireksiId($bukuDireksiId);
		if($bukuDireksi->issetBukuDireksiId())
		{
			...
			$columToBeCopied = array(
				...
				Field::of()->komentarDireksi, 
				Field::of()->aktif
			);

			$approval->approve($columToBeCopied, new BukuDireksiApv(), new BukuDireksiTrash(), 
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<textarea class="form-control summernote" name="permasalahan" id="permasalahan" spellcheck="false"></textarea>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<textarea class="form-control summernote" name="penyelesaian" id="penyelesaian" spellcheck="false"></textarea>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="nama_direksi" id="nama_direksi"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getJabatanDireksi();?></td>
						<td>
							<input autocomplete="off" class="form-control" type="text" name="jabatan_direksi" id="jabatan_direksi"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKomentarDireksi();?></td>
						<td>
							<textarea class="form-control summernote" name="komentar_direksi" id="komentar_direksi"></textarea>
						</td>
					</tr>
					<tr>
...
else if($inputGet->getUserAction() == UserAction::UPDATE)
{
	...
	$specs = PicoSpecification::getInstanceOf(Field::of()->bukuDireksiId, $inputGet->getBukuDireksiId());
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td><?php echo $appEntityLanguage->getNama();?></td>
						<td>
							<input class="form-control" type="text" name="nama" id="nama" value="<?php echo $bukuDireksi->getNama();?>" autocomplete="off" required="required"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getProyek();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getPermasalahan();?></td>
						<td>
							<textarea class="form-control summernote" name="permasalahan" id="permasalahan" spellcheck="false"><?php echo $bukuDireksi->getPermasalahan();?></textarea>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getPerkiraanLamaPenyelesaian();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getPenyelesaian();?></td>
						<td>
							<textarea class="form-control summernote" name="penyelesaian" id="penyelesaian" spellcheck="false"><?php echo $bukuDireksi->getPenyelesaian();?></textarea>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getStatus();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getNamaDireksi();?></td>
						<td>
							<input class="form-control" type="text" name="nama_direksi" id="nama_direksi" value="<?php echo $bukuDireksi->getNamaDireksi();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getJabatanDireksi();?></td>
						<td>
							<input class="form-control" type="text" name="jabatan_direksi" id="jabatan_direksi" value="<?php echo $bukuDireksi->getJabatanDireksi();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getKomentarDireksi();?></td>
						<td>
							<textarea class="form-control summernote" name="komentar_direksi" id="komentar_direksi"><?php echo $bukuDireksi->getKomentarDireksi();?></textarea>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
...
else if($inputGet->getUserAction() == UserAction::DETAIL)
{
	...
	try{
		...
		$bukuDireksi->findOne($specs, null, $subqueryMap);
		if($bukuDireksi->issetBukuDireksiId())
		{
			// Define map here
			...
			<table class="responsive responsive-three-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getPermasalahan();?></td>
						<td>
							<span class="<?php echo AppFormBuilder::classCompareData($bukuDireksi->notEqualsPermasalahan($bukuDireksiApv->getPermasalahan()));?>"><?php echo $bukuDireksi->getPermasalahan();?></span>
						</td>
						<td>
							<span class="<?php echo AppFormBuilder::classCompareData($bukuDireksi->notEqualsPermasalahan($bukuDireksiApv->getPermasalahan()));?>"><?php echo $bukuDireksiApv->getPermasalahan();?></span>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getPerkiraanLamaPenyelesaian();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getKomentarDireksi();?></td>
						<td>
							<span class="<?php echo AppFormBuilder::classCompareData($bukuDireksi->notEqualsKomentarDireksi($bukuDireksiApv->getKomentarDireksi()));?>"><?php echo $bukuDireksi->getKomentarDireksi();?></span>
						</td>
						<td>
							<span class="<?php echo AppFormBuilder::classCompareData($bukuDireksi->notEqualsKomentarDireksi($bukuDireksiApv->getKomentarDireksi()));?>"><?php echo $bukuDireksiApv->getKomentarDireksi();?></span>
						</td>
					</tr>
					<tr>
		...
		<form name="detailform" id="detailform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuBuat();?></td>
						<td><?php echo $bukuDireksi->getWaktuBuat();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $bukuDireksi->getWaktuUbah();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getIpBuat();?></td>
...
if($inputGet->getUserAction() == UserAction::EXPORT)
{
	...
	$exporter->write($pageData, $fileName, $sheetName, array(
		...
		$appEntityLanguage->getKomentarDireksi() => $headerFormat->getKomentarDireksi(),
					...
					<table class="table table-row table-sort-by-column">
						<thead>
							<tr>
								...
								<td data-col-name="nama_direksi" class="order-controll"><a href="#"><?php echo $appEntityLanguage->getNamaDireksi();?></a></td>
						...
						<tbody data-offset="<?php echo $pageData->getDataOffset();?>">
							...
							<tr data-number="<?php echo $pageData->getDataOffset() + $dataIndex;?>">
								...
								<td data-col-name="nama"><?php echo $bukuDireksi->getNama();?></td>
								<td data-col-name="proyek_id"><?php echo $bukuDireksi->issetProyek() ? $bukuDireksi->getProyek()->getNama() : "";?></td>
								<td data-col-name="supervisor_id"><?php echo $bukuDireksi->issetSupervisor() ? $bukuDireksi->getSupervisor()->getNama() : "";?></td>
								...
								<td data-col-name="nama_direksi"><?php echo $bukuDireksi->getNamaDireksi();?></td>
