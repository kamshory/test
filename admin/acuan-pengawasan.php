...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$acuanPengawasan->setProyekId($inputPost->getProyekId(PicoFilterConstant::FILTER_SANITIZE_NUMBER_INT, false, false, true));
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td><?php echo $appEntityLanguage->getNama();?></td>
						<td>
							<input type="text" class="form-control" name="nama" id="nama" value="<?php echo $acuanPengawasan->getNama();?>" autocomplete="off" required="required"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getNomor();?></td>
						<td>
							<input type="text" class="form-control" name="nomor" id="nomor" value="<?php echo $acuanPengawasan->getNomor();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getProyek();?></td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getSortOrder();?></td>
						<td>
							<input type="number" step="1" class="form-control" name="sort_order" id="sort_order" value="<?php echo $acuanPengawasan->getSortOrder();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $acuanPengawasan->issetPembuat() ? $acuanPengawasan->getPembuat()->getNama() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAdminUbah();?></td>
						<td><?php echo $acuanPengawasan->issetPengubah() ? $acuanPengawasan->getPengubah()->getNama() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuBuat();?></td>
						<td><?php echo $acuanPengawasan->dateFormatWaktuBuat('j F Y H:i:s');?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $acuanPengawasan->dateFormatWaktuUbah('j F Y H:i:s');?></td>
					</tr>
					<tr>
...
$specMap = array(
	...
	"jenisHirarkiKontrakId" => PicoSpecification::filter("jenisHirarkiKontrakId", "number"),
	...
	<div class="jambi-wrapper">
		<div class="filter-section">
			<form action="" method="get" class="filter-form">
				...
				<span class="filter-group">
					<span class="filter-label"><?php echo $appEntityLanguage->getJenisHirarkiKontrak();?></span>
					<span class="filter-control">
							<select class="form-control" name="jenis_hirarki_kontrak_id">
								<option value=""><?php echo $appLanguage->getLabelOptionSelectOne();?></option>
								<?php echo AppFormBuilder::getInstance()->createSelectOption(new JenisHirarkiKontrakMin(null, $database), 
								PicoSpecification::getInstance()
									->addAnd(new PicoPredicate(Field::of()->aktif, true))
								...
								PicoSortable::getInstance()
									->add(new PicoSort(Field::of()->sortOrder, PicoSort::ORDER_TYPE_ASC))
									->add(new PicoSort(Field::of()->nama, PicoSort::ORDER_TYPE_ASC)), 
								Field::of()->jenisHirarkiKontrakId, Field::of()->nama, $inputGet->getJenisHirarkiKontrakId())
								; ?>
							</select>
					</span>
				</span>
