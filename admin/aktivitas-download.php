...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "aktivitas-download", "Aktivitas Download");
...
if($inputPost->getUserAction() == UserAction::CREATE)
{
	...
	$aktivitasDownload->setUserId($inputPost->getUserId(PicoFilterConstant::FILTER_SANITIZE_NUMBER_INT, false, false, true));
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="ip_download" id="ip_download"/>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getUrl();?></td>
						<td>
							<input class="form-control" type="text" name="url" id="url" value="<?php echo $aktivitasDownload->getUrl();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getUser();?></td>
						<td>
							<select class="form-control" name="user_id" id="user_id">
								...
								PicoSortable::getInstance()
									->add(new PicoSort(Field::of()->sortOrder, PicoSort::ORDER_TYPE_ASC))
									->add(new PicoSort(Field::of()->nama, PicoSort::ORDER_TYPE_ASC)), 
								Field::of()->userId, Field::of()->firstName, $aktivitasDownload->getUserId())
								; ?>
							</select>
						</td>
					</tr>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getIpDownload();?></td>
						<td>
							<input class="form-control" type="text" name="ip_download" id="ip_download" value="<?php echo $aktivitasDownload->getIpDownload();?>" autocomplete="off"/>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<form name="detailform" id="detailform" action="" method="post">
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getUser();?></td>
						<td><?php echo $aktivitasDownload->issetUser() ? $aktivitasDownload->getUser()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getSupervisor();?></td>
					...
					<table class="table table-row table-sort-by-column">
						...
						<tbody data-offset="<?php echo $pageData->getDataOffset();?>">
							...
							<tr data-number="<?php echo $pageData->getDataOffset() + $dataIndex;?>">
								...
								<td data-col-name="user_id"><?php echo $aktivitasDownload->issetUser() ? $aktivitasDownload->getUser()->getFirstName() : "";?></td>
