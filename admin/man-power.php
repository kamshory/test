...
{
$appEntityLanguage = new AppEntityLanguageImpl(new ManPower(), $appConfig, $currentUser->getLanguageId());
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" type="text" class="form-control" name="jumlah_pekerja" id="jumlah_pekerja"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getNama();?></td>
						<td>
							<input type="text" class="form-control" name="nama" id="nama" value="<?php echo $manPower->getNama();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getPekerjaan();?></td>
						<td>
							<input type="text" class="form-control" name="pekerjaan" id="pekerjaan" value="<?php echo $manPower->getPekerjaan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getJumlahPekerja();?></td>
						<td>
							<input type="text" class="form-control" name="jumlah_pekerja" id="jumlah_pekerja" value="<?php echo $manPower->getJumlahPekerja();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getSortOrder();?></td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $manPower->dateFormatWaktuBuat('j F Y H:i:s');?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $manPower->dateFormatWaktuUbah('j F Y H:i:s');?></td>
					</tr>
					<tr>
