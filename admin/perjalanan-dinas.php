...
$currentModule = new PicoModule($appConfig, $database, $appModule, "/admin", "perjalanan-dinas", $appLanguage->getPerjalananDinas());
...
{
$appEntityLanguage = new AppEntityLanguageImpl(new PerjalananDinas(), $appConfig, $currentUser->getLanguageId());
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
						...
						<td>
							<select class="form-control" name="tsk_id" id="tsk_id">
								...
								PicoSortable::getInstance()
									->add(new PicoSort("umk.nama", PicoSort::ORDER_TYPE_ASC))
									->add(new PicoSort(Field::of()->nama, PicoSort::ORDER_TYPE_ASC)), 
								Field::of()->tskId, Field::of()->nama, $perjalananDinas->getTskId())
								->setGroup(Field::of()->umkId, Field::of()->nama, Field::of()->umk)
								; ?>
							</select>
						</td>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuDibayar();?></td>
						<td>
							<input type="datetime-local" class="form-control" name="waktu_dibayar" id="waktu_dibayar" value="<?php echo $perjalananDinas->getWaktuDibayar();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAktif();?></td>
