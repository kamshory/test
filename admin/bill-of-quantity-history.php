			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $billOfQuantityHistory->issetPembuat() ? $billOfQuantityHistory->getPembuat()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getPengubah();?></td>
						<td><?php echo $billOfQuantityHistory->issetPengubah() ? $billOfQuantityHistory->getPengubah()->getFirstName() : "";?></td>
					</tr>
					<tr>
