			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<td>
							<input autocomplete="off" class="form-control" type="text" name="status_acuan_pengawasan_id" id="status_acuan_pengawasan_id"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						<td><?php echo $appEntityLanguage->getStatusAcuanPengawasanId();?></td>
						<td>
							<input class="form-control" type="text" name="app_builder_new_pk_status_acuan_pengawasan_id" id="status_acuan_pengawasan_id" value="<?php echo $statusAcuanPengawasan->getStatusAcuanPengawasanId();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getNama();?></td>
						<td>
							<input class="form-control" type="text" name="nama" id="nama" value="<?php echo $statusAcuanPengawasan->getNama();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getSortOrder();?></td>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td><?php echo $statusAcuanPengawasan->issetPembuat() ? $statusAcuanPengawasan->getPembuat()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getAdminUbah();?></td>
						<td><?php echo $statusAcuanPengawasan->issetPengubah() ? $statusAcuanPengawasan->getPengubah()->getFirstName() : "";?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuBuat();?></td>
						<td><?php echo $statusAcuanPengawasan->getWaktuBuat();?></td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getWaktuUbah();?></td>
						<td><?php echo $statusAcuanPengawasan->getWaktuUbah();?></td>
					</tr>
					<tr>
