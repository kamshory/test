...
if($inputPost->getUserAction() == UserAction::CREATE && $inputPost->getJenisKehadiran() != "")
{
    ...
    try
    {
        ...
        $kehadiran->findOneByGrupPenggunaAndSupervisorIdAndTanggal($grupPengguna, $supervisorId, $tanggal);
    }
    catch(Exception $e)
    {
        $kehadiran = new Kehadiran(null, $database);
	...
	$kehadiran->setGrupPengguna($grupPengguna);
