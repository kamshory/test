			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td>
							<input autocomplete="off" type="text" class="form-control" name="keterangan" id="keterangan"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getLambang();?></td>
						<td>
							<input autocomplete="off" type="text" class="form-control" name="lambang" id="lambang"/>
						</td>
					</tr>
					<tr>
			...
			<table class="responsive responsive-two-cols" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					...
					<tr>
						<td><?php echo $appEntityLanguage->getKeterangan();?></td>
						<td>
							<input type="text" class="form-control" name="keterangan" id="keterangan" value="<?php echo $jenisCuti->getKeterangan();?>" autocomplete="off"/>
						</td>
					</tr>
					<tr>
						<td><?php echo $appEntityLanguage->getLambang();?></td>
